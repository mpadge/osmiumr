...
[![Codecov test coverage](https://codecov.io/gh/mpadge/rosmium/branch/main/graph/badge.svg)](https://codecov.io/gh/mpadge/rosmium)
...
[`libosmium`](https://osmcode.org/libosmium/) library. The package contains R
functions for most of the `osmium-tool` functionality described in [the
manual](https://osmcode.org/osmium-tool/manual.html).
...
Grab a small real-world extract to work with -- the "ITS Leeds" test file used
in the [`osmextract` package](https://docs.ropensci.org/osmextract/):
